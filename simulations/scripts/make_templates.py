        ...
        for case, params in cases.items():
            if code == "transp":
                ...
                txt = (
                    ...
                    f"MAJOR_RADIUS_R = 6.0     ; m (φ design)\n"
                    f"MINOR_RADIUS_a = 3.708   ; m (R/φ)\n"
                    f"ELONGATION_KAPPA = 0.809 ; φ/2\n"
                    f"TOROIDAL_FIELD_Bt = 8.1  ; T\n"
                    f"PLASMA_CURRENT_Ip = 12.5 ; MA\n"
                    f"; φ-harmonic tuned parameters autogenerated\n"
                ...
                txt = (
                    ...
                    f"! φ-harmonic eqdsk header\n"
                    f"ASPECT_RATIO 1.618\n"
                    f"ELONGATION 0.809\n"
                    f"; Auto-generated {DATE}\n"
